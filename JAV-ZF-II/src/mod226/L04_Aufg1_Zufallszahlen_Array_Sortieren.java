...
public class L04_Aufg1_Zufallszahlen_Array_Sortieren {
	...
	public static void main(String[] args) {
		/* Generiere 30 Zahlen zwischen 1-50
		Speichere diese im Array und gib diese aus
		Sortiere nun diese Zahlen und gib sie aus
		An wie vielen Positionen stand im alten Array eine grössere Zahl?
		Vergleiche die Positionen einzeln: altes Array > neue Position
